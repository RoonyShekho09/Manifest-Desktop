...
//            docPage?.del(Light.All)
    ...
    fun adaptiveThreshold(source: BufferedImage, blockSize: Int = 15, offset: Int = 10): BufferedImage {
        ...
        for (y in 0 until height) {
            for (x in 0 until width) {
                ...
                val pixel = if (gray[y][x] < localMean - offset) Color.BLACK.rgb else Color.WHITE.rgb
